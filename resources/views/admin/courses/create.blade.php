      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border border-gray-300">
            ...
            <form action="{{ route('admin.courses.store') }}" method="POST" class="max-w-lg mx-auto border p-6 rounded">
              @csrf
              <div class="mb-4">
              ...
              <div class="mb-4">
                ...
                <input type="number" name="duration" id="duration" value="{{ old('duration') }}" class="border border-gray-400 p-2 rounded w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              </div>
